...
-- 뉴진스(1)
(1, "민지", "리더, 메인보컬, 메인댄서", "여", "2004-05-07", "한국", 1),
(2, "하니", "서브보컬, 메인래퍼, 리드댄서", "여", "2004-10-06", "호주, 베트남", 1),
(3, "다니엘", "서브보컬, 서브래퍼, 메인댄서", "여", "2005-04-11", "한국, 호주", 1),
(4, "해린", "서브보컬, 리드댄서, 비주얼", "여", "2006-05-15", "한국", 1),
(5, "혜인", "메인보컬, 서브댄서", "여", "2008-04-21", "한국", 1),
...
-- 세븐틴(4)
(17, "에스쿱스", "힙합유닛리더, 리더, 메인래퍼", "남", "1995-08-08", "한국", 4),
(18, "정한", "서브보컬", "남", "1995-10-04", "한국", 4),
(19, "조슈아", "서브보컬", "남", "1995-12-30", "미국", 4),
(20, "준", "리드댄서, 서브보컬", "남", "1996-06-10", "중국", 4),
(21, "호시", "퍼포먼스유닛리더, 메인댄서, 리드보컬", "남", "1996-06-15", "한국", 4),
(22, "원우", "리드래퍼", "남", "1996-07-17", "한국", 4),
(23, "우지", "보컬유닛리더, 메인보컬", "남", "1996-11-22", "한국", 4),
...
(61, "휴닝카이", "리드보컬, 서브래퍼", "남", "2002-08-14", "미국", 10);